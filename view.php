...
if ($search !== '') {
    $query = "SELECT * FROM students WHERE name LIKE '%$search%' OR course LIKE '%$search%' ORDER BY id DESC";
} else {
...
<body class="light-mode">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="delete.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-jdm" onclick="return confirm('Are you sure?')">DELETE</a>
                </td>
              </tr>
              <?php endwhile; ?>
            </tbody>
  ...
  <div class="credits-btn">
    <button id="creditsBtn" class="btn btn-link">Created by: 
      <span class="neon-text">Balighot</span>, 
