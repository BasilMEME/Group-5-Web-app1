...
<body class="light-mode">
  ...
  <div class="credits-btn">
    <button id="creditsBtn" class="btn btn-link">Created by: <span class="neon-text">Balighot</span>, <span class="neon-text">Defeo</span>, <span class="neon-text">Turaya</span></button>
  </div>
</body>
</html>